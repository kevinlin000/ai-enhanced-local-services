...
class MongoDBStorage:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            # Only pass tlsAllowInvalidCertificates when True — pymongo 4.x
            # enables TLS implicitly if ANY tls kwarg is present (even False).
            if self.tls_allow_invalid_certs:
                _kwargs["tlsAllowInvalidCertificates"] = True
            self.client = pymongo.MongoClient(self.uri, **_kwargs)
            # Test connection
