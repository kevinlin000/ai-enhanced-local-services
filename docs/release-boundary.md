...
| Scorecard and 100-point path | portfolio readiness score, role-specific framing, remaining gaps, evidence package, recording script, recording/cloud plan, architecture overview, next plan |
