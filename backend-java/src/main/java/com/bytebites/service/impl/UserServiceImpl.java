...
import com.bytebites.mapper.UserMapper;
...
import com.bytebites.security.JwtTokenProvider;
import com.bytebites.utils.RegexUtils;
...
import static com.bytebites.utils.SystemConstants.USER_NICK_NAME_PREFIX;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result sendCode(String phone, HttpSession session) {
        ...
        //5. 發送驗證碼
        log.debug("send sms code to phone ending with {}", phone.substring(phone.length() - 4));
        //6. 返回ok
        return Result.ok();
    }
